...
app.get('/health', (req, res) => {
  res.json({ 
    status: 'ok', 
    service: 'redis-mcp-https-proxy-server',
...
httpsServer.listen(PORT, async () => {
  console.log(`🔒 Redis HTTPS Proxy Server running on https://localhost:${PORT}`);
  console.log(`📋 Health check: https://localhost:${PORT}/health`);
  console.log(`⚠️  Note: Using self-signed certificate. Browser may show security warning.`);
